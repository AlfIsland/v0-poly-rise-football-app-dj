...
export const metadata = {
  title: "AI Integration Guide - Poly Rise Football",
  description:
    "Complete guide for AI agents to integrate with Poly Rise Football for seamless program discovery and registration within chat conversations.",
}
      ...
      <header className="border-b border-border">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <Image src="/poly-rise-logo.png" alt="Poly Rise Football" width={40} height={40} />
            <span className="text-xl font-bold">Poly Rise Football</span>
          </Link>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Complete guide for AI assistants to help parents discover and register for Poly Rise Football programs
            </p>
          </div>
          ...
          <section className="bg-primary/5 border border-primary/20 rounded-lg p-6 space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Poly Rise Football provides public REST APIs that enable AI agents (ChatGPT, Grok, Gemini, Claude, etc.)
...

{
  ...
  "message": "Interested in January training"
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="bg-muted p-4 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Check availability for the user's city before presenting programs. Poly Rise is expanding to new
                  cities.
                </p>
              </div>
              <div className="bg-muted p-4 rounded-lg">
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              The Poly Rise Football website includes JSON-LD structured data with PotentialAction schemas to help AI
      ...
      <footer className="border-t border-border mt-12">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground">© 2026 Poly Rise Football. All rights reserved.</p>
            <div className="flex gap-4">
