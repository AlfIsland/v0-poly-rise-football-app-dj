...
export const metadata = {
  title: "API Documentation - Poly Rise Football",
  description:
    "Public REST API documentation for AI agents and developers to integrate with Poly Rise Football programs, check availability, and submit registration inquiries.",
}
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Public REST API for AI agents and developers to integrate with Poly Rise Football
            </p>
          </div>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              The Poly Rise Football API enables AI agents (ChatGPT, Grok, Gemini, Claude) and developers to
