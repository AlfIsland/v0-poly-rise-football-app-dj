...
const SYSTEM_PROMPT = `You are the Lead Generation Agent for PolyRISE Athletix — elite youth football training in Dripping Springs, Texas (Austin area), founded by NFL veteran Coach Kevin Garrett.
