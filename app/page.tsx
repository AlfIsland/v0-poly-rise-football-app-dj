...
export default function HomePage() {
  return (
    <>
      ...
      {/* Navigation */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 border-b-2 border-[#CC0000]/60">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#CC0000]/20 via-background to-background" />
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="mt-16 pt-12 border-t border-gray-800">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {/* Player Development */}
              <div className="bg-card border-[#CC0000]/70 border-2 overflow-hidden group hover:border-[#CC0000] transition-colors">
              ...
              <div className="bg-card border-[#CC0000]/70 border-2 overflow-hidden group hover:border-[#CC0000] transition-colors relative">
                <div className="aspect-video relative overflow-hidden">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://www.facebook.com/profile.php?id=61573903568901" target="_blank" rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-muted hover:bg-primary hover:text-[#CC0000]-foreground transition-colors flex items-center justify-center">
