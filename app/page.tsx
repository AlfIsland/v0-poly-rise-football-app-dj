  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <nav className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-8">
              ...
              <Link href="/plans" className="text-xs font-black uppercase tracking-widest bg-[#CC0000] text-white px-5 py-2.5 hover:bg-[#AA0000] transition-colors">
                View Plans
              </Link>
            </div>
          </nav>
      ...
      <section className="relative pt-36 pb-20 lg:pt-48 lg:pb-36 overflow-hidden bg-black">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,_#CC0000_0%,_transparent_50%)] opacity-10" />
            ...
            <div className="space-y-8">
              <div className="space-y-2">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-[#CC0000] text-xs font-black uppercase tracking-[0.2em]">Austin & Central Texas</span>
                </div>
                <h1 className="text-5xl lg:text-7xl font-display font-black leading-none tracking-tight text-white">
                  Elite Youth<br />
                  <span className="text-[#CC0000]">Multi-Sport</span><br />
                  Development
                </h1>
              </div>
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <Link href="#programs" className="inline-flex items-center gap-2 bg-[#CC0000] text-white px-6 py-3 text-xs font-black uppercase tracking-widest hover:bg-[#AA0000] transition-colors">
                  View Programs <ArrowRight className="w-3.5 h-3.5" />
                </Link>
                <Link href="#contact" className="inline-flex items-center gap-2 border border-white/20 text-white px-6 py-3 text-xs font-black uppercase tracking-widest hover:border-[#CC0000] hover:text-[#CC0000] transition-colors">
                  Contact Us
                </Link>
              </div>
            </div>
              ...
              <div className="absolute -bottom-6 -left-6 bg-card border border-border rounded-xl p-6 shadow-2xl">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-[#CC0000]/10 flex items-center justify-center">
                    <Trophy className="w-6 h-6 text-[#CC0000]" />
                  </div>
                  <div>
      ...
      <section id="programs" className="py-12 lg:py-20 bg-black">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-4">
            <p className="text-[#CC0000] font-bold text-xs uppercase tracking-widest mb-3">PolyRISE Athletix</p>
          ...
          <div className="mt-16 pt-12 border-t border-gray-800">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {/* Player Development */}
              <div className="bg-[#0a0a0a] border border-white/5 border-t-2 border-t-[#CC0000] overflow-hidden group transition-colors">
                ...
                <div className="pt-6 px-6 pb-6 space-y-4">
                  <div>
                    ...
                    <div className="space-y-2 border-t border-dashed border-border pt-4">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="font-medium text-sm">Annual <span className="text-xs text-[#CC0000] font-semibold">Save more</span></span>
                  ...
                  <Link href="/register?program=player-dev" className="block w-full text-center bg-[#CC0000] text-white px-4 py-3 text-xs font-black uppercase tracking-widest hover:bg-[#aa0000] transition-colors">Register</Link>
                </div>
              </div>

              {/* Multi-Sport Development */}
              <div className="bg-[#0a0a0a] border border-white/5 border-t-2 border-t-[#CC0000] overflow-hidden group transition-colors relative">
                <div className="aspect-video relative overflow-hidden">
                ...
                <div className="pt-6 px-6 pb-6 space-y-4">
                  ...
                  <Link href="/register?program=multi-sport-dev" className="block w-full text-center bg-[#CC0000] text-white px-4 py-3 text-xs font-black uppercase tracking-widest hover:bg-[#aa0000] transition-colors">Register</Link>
                </div>
              </div>
              ...
              <div className="bg-[#0a0a0a] border border-white/5 border-t-2 border-t-[#CC0000] overflow-hidden group transition-colors">
                <div className="pt-6 px-6 pb-6 space-y-4">
                  <div>
                    ...
                    <p className="text-sm font-display font-semibold text-[#CC0000] italic mb-2">Rise of Warriors</p>
                    ...
                    <ul className="space-y-1 mt-3">
                      <li className="flex items-start gap-2 text-sm text-muted-foreground"><CheckCircle2 className="w-4 h-4 text-[#CC0000] flex-shrink-0 mt-0.5" />Middle School: 10 teams - $400</li>
                      <li className="flex items-start gap-2 text-sm text-muted-foreground"><CheckCircle2 className="w-4 h-4 text-[#CC0000] flex-shrink-0 mt-0.5" />High School: 8 teams - $425</li>
                      <li className="flex items-start gap-2 text-sm text-muted-foreground"><CheckCircle2 className="w-4 h-4 text-[#CC0000] flex-shrink-0 mt-0.5" />Min. 3 games, single elimination</li>
                    </ul>
                  </div>
                  <Link href="/register?program=tournament-ms" className="block w-full text-center bg-[#CC0000] text-white px-4 py-3 text-xs font-black uppercase tracking-widest hover:bg-[#aa0000] transition-colors">Register Team</Link>
                </div>
              </div>
              ...
              <div className="bg-[#0a0a0a] border border-white/5 border-t-2 border-t-[#CC0000] overflow-hidden group transition-colors">
                <div className="pt-6 px-6 pb-6 space-y-4">
                  <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#CC0000]/10 border border-[#CC0000]/20 mb-3">
                      <span className="text-sm font-medium text-[#CC0000]">Girls Program</span>
                    </div>
                  ...
                  <Link href="/register?program=girls-dev" className="block w-full text-center bg-[#CC0000] text-white px-4 py-3 text-xs font-black uppercase tracking-widest hover:bg-[#aa0000] transition-colors">Register</Link>
                </div>
              </div>
              ...
              <div className="bg-[#0a0a0a] border border-white/5 border-t-2 border-t-[#CC0000] overflow-hidden group transition-colors">
                <div className="pt-6 px-6 pb-6 space-y-4">
                  ...
                  <Link href="/register?program=multi-sport" className="block w-full text-center bg-[#CC0000] text-white px-4 py-3 text-xs font-black uppercase tracking-widest hover:bg-[#aa0000] transition-colors">Register</Link>
                </div>
              </div>
              ...
              <div className="bg-[#0a0a0a] border border-white/5 border-t-2 border-t-[#CC0000] overflow-hidden group transition-colors">
                <div className="pt-6 px-6 pb-6 space-y-4">
                  <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#CC0000]/10 border border-[#CC0000]/20 mb-3">
                      <span className="text-sm font-medium text-[#CC0000]">Drop-In</span>
                    </div>
                  ...
                  <Link href="/register?program=drop-in-1day" className="block w-full text-center bg-[#CC0000] text-white px-4 py-3 text-xs font-black uppercase tracking-widest hover:bg-[#aa0000] transition-colors">Register</Link>
                </div>
              </div>
              ...
              <div className="bg-[#0a0a0a] border border-white/5 border-t-2 border-t-[#CC0000] overflow-hidden group transition-colors">
                <div className="pt-6 px-6 pb-6 space-y-4">
                  <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#CC0000]/10 border border-[#CC0000]/20 mb-3">
                      <span className="text-sm font-medium text-[#CC0000]">Leadership</span>
                    </div>
                  ...
                  <Link href="/register?program=hike" className="block w-full text-center bg-[#CC0000] text-white px-4 py-3 text-xs font-black uppercase tracking-widest hover:bg-[#aa0000] transition-colors">Register</Link>
                </div>
              </div>
              ...
              <div className="bg-[#0a0a0a] border border-white/5 border-t-2 border-t-[#CC0000] overflow-hidden group transition-colors">
                <div className="pt-6 px-6 pb-6 space-y-4">
                  <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#CC0000]/10 border border-[#CC0000]/20 mb-3">
                      <span className="text-sm font-medium text-[#CC0000]">Camp</span>
                    </div>
                  ...
                  <Link href="/register?program=tackling-camp" className="block w-full text-center bg-[#CC0000] text-white px-4 py-3 text-xs font-black uppercase tracking-widest hover:bg-[#aa0000] transition-colors">Register</Link>
                </div>
              </div>
              ...
              <div className="bg-[#0a0a0a] border border-white/5 border-t-2 border-t-[#CC0000] overflow-hidden group transition-colors">
                <div className="pt-6 px-6 pb-6 space-y-4">
                  ...
                  <Link href="/register?program=combine" className="block w-full text-center bg-[#CC0000] text-white px-4 py-3 text-xs font-black uppercase tracking-widest hover:bg-[#aa0000] transition-colors">Register</Link>
                </div>
              </div>

              {/* Summer Camp */}
              <div className="bg-card border-[#CC0000]/70 border-2 overflow-hidden group hover:border-[#CC0000] transition-colors lg:col-span-3">
                <div className="pt-6 px-6 pb-6 space-y-4">
                  <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#CC0000]/10 border border-[#CC0000]/20 mb-3">
                      <span className="text-sm font-medium text-[#CC0000]">Summer Camp</span>
                    </div>
                  ...
                  <Link href="/register?program=summer-ms" className="block w-full text-center bg-[#CC0000] text-white px-4 py-3 text-xs font-black uppercase tracking-widest hover:bg-[#aa0000] transition-colors">Register Now</Link>
                </div>
              </div>

              {/* Recruiting — Kevin Garrett */}
              <div className="bg-card border-[#CC0000]/70 border-2 overflow-hidden lg:col-span-3">
                <div className="pt-6 px-6 pb-6 space-y-4">
                  ...
                  <div className="flex flex-wrap justify-center gap-4">
                    <img src="/recruiting-athlete-1.jpeg" alt="Athlete Introduction Example - James Cabarrus III" className="w-48 h-auto rounded-lg border border-[#CC0000]/20" />
                    <img src="/recruiting-athlete-2.jpeg" alt="Athlete Introduction Example - Gevariah Kneubuhl" className="w-48 h-auto rounded-lg border border-[#CC0000]/20" />
                  </div>
                  <div className="text-center">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 max-w-6xl mx-auto">
            <div className="text-center p-4 bg-card rounded-lg border border-border">
              <div className="w-24 h-24 mx-auto mb-3 rounded-full overflow-hidden border-2 border-[#CC0000]">
              ...
              <p className="text-xs text-[#CC0000] font-semibold mb-2">DB Coach</p>
            ...
            <div className="text-center p-4 bg-card rounded-lg border border-border">
              ...
              <p className="text-xs text-[#CC0000] font-semibold mb-2">WR/TE</p>
              <p className="text-xs text-muted-foreground">XFL Draft 2022, Omaha Beef 2X Champion, HCU Assistant WR Coach</p>
            </div>
            <div className="text-center p-4 bg-card rounded-lg border border-border">
              <div className="w-24 h-24 rounded-full overflow-hidden mx-auto mb-3 border-2 border-[#CC0000]/20">
              ...
              <p className="text-xs text-[#CC0000] font-semibold mb-2">RB/S</p>
            ...
            <div className="text-center p-4 bg-card rounded-lg border border-border">
              ...
              <p className="text-xs text-[#CC0000] font-semibold mb-2">QB</p>
            ...
            <div className="text-center p-4 bg-card rounded-lg border border-border">
              ...
              <p className="text-xs text-[#CC0000] font-semibold mb-2">LB/DL</p>
      ...
      <section className="py-12 lg:py-20">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 lg:gap-16">
            <div className="w-44 h-40 rounded-lg border-2 border-[#CC0000]/20 bg-white flex items-center justify-center overflow-hidden hover:border-[#CC0000]/70 transition-colors p-4">
          ...
          <div className="text-center mt-12">
            ...
            <a href="#contact" className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-primary text-[#CC0000]-foreground font-medium hover:bg-primary/90 transition-colors">
              Contact Us
            </a>
          </div>
        </div>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#CC0000]/10 flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#CC0000]/10 flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-[#CC0000]" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section id="register" className="py-12 lg:py-20 bg-primary">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <h2 className="text-4xl lg:text-5xl font-display font-bold text-[#CC0000]-foreground text-balance">
              Ready to Start Your Journey?
            </h2>
            <p className="text-lg text-[#CC0000]-foreground/90 leading-relaxed text-pretty">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="#contact" className="text-base bg-transparent border border-[#CC0000] px-4 py-2 rounded hover:bg-[#CC0000]/10 transition-colors">
                Contact Us
              </Link>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center">
                  <span className="text-[#CC0000]-foreground font-display font-bold">PR</span>
                </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://www.facebook.com/profile.php?id=61573903568901" target="_blank" rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-[#0a0a0a] hover:bg-primary hover:text-[#CC0000]-foreground transition-colors flex items-center justify-center">
