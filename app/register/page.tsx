...
const PROGRAMS_DATA: Record<string, { name: string; price: number; priceLabel: string; billing: "one_time" | "monthly" }> = {
  ...
  "summer-k5":            { name: "Summer Camp — Elementary (K-5)",        price: 265, priceLabel: "$265/mo",  billing: "monthly" },
  "summer-ms":            { name: "Summer Camp — Middle School",           price: 265, priceLabel: "$265/mo",  billing: "monthly" },
  "summer-hs":            { name: "Summer Camp — High School",             price: 265, priceLabel: "$265/mo",  billing: "monthly" },
