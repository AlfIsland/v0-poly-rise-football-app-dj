...
export default function ProgressReportDownload({ athlete }: { athlete: Athlete }) {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      doc.text(athlete.sport === "soccer" ? "PolyRISE Soccer" : athlete.sport === "flag-football" ? "PolyRISE Flag Football" : "PolyRISE Athletix", margin + 27, 13)
      ...
      for (let p = 1; p <= totalPages; p++) {
        ...
        doc.text("PolyRISE Athletix · Austin, Texas · polyrisefootball.com · (817) 658-3300", W / 2, footerY + 8, { align: "center" })
