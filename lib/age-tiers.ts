...
const FEMALE: Record<string, Thresholds[]> = {
  // All speed thresholds +0.2s in athlete's favor
  fortyYard: [
    { elite: 6.10, aboveAvg: 6.40, average: 6.80, lower: true },
    { elite: 5.90, aboveAvg: 6.20, average: 6.60, lower: true },
    { elite: 5.80, aboveAvg: 6.10, average: 6.50, lower: true },
    { elite: 5.60, aboveAvg: 5.90, average: 6.30, lower: true },
    { elite: 5.50, aboveAvg: 5.80, average: 6.20, lower: true },
    { elite: 5.40, aboveAvg: 5.70, average: 6.10, lower: true },
    { elite: 5.30, aboveAvg: 5.60, average: 6.00, lower: true },
    { elite: 5.20, aboveAvg: 5.50, average: 5.90, lower: true },
  ],
  twentyYard: [
    { elite: 3.30, aboveAvg: 3.50, average: 3.70, lower: true },
    { elite: 3.20, aboveAvg: 3.40, average: 3.60, lower: true },
    { elite: 3.10, aboveAvg: 3.30, average: 3.50, lower: true },
    { elite: 3.05, aboveAvg: 3.25, average: 3.45, lower: true },
    { elite: 3.00, aboveAvg: 3.20, average: 3.40, lower: true },
    { elite: 2.95, aboveAvg: 3.15, average: 3.35, lower: true },
    { elite: 2.90, aboveAvg: 3.10, average: 3.30, lower: true },
    { elite: 2.85, aboveAvg: 3.05, average: 3.25, lower: true },
  ],
  shuttle: [
    { elite: 5.20, aboveAvg: 5.50, average: 5.80, lower: true },
    { elite: 5.05, aboveAvg: 5.35, average: 5.65, lower: true },
    { elite: 4.90, aboveAvg: 5.20, average: 5.50, lower: true },
    { elite: 4.80, aboveAvg: 5.10, average: 5.40, lower: true },
    { elite: 4.70, aboveAvg: 5.00, average: 5.30, lower: true },
    { elite: 4.60, aboveAvg: 4.90, average: 5.20, lower: true },
    { elite: 4.55, aboveAvg: 4.85, average: 5.15, lower: true },
    { elite: 4.50, aboveAvg: 4.80, average: 5.10, lower: true },
  ],
  threeCone: [
    { elite: 8.00, aboveAvg: 8.50, average: 9.00, lower: true },
    ...
    { elite: 7.20, aboveAvg: 7.70, average: 8.20, lower: true },
    { elite: 7.00, aboveAvg: 7.50, average: 8.00, lower: true },
    { elite: 6.90, aboveAvg: 7.40, average: 7.90, lower: true },
    { elite: 6.80, aboveAvg: 7.30, average: 7.80, lower: true },
  ],
  // All jump thresholds -2 in athlete's favor
  verticalJump: [
    { elite: 16, aboveAvg: 12, average: 8,  lower: false },
    { elite: 18, aboveAvg: 14, average: 10, lower: false },
    { elite: 20, aboveAvg: 16, average: 12, lower: false },
    { elite: 21, aboveAvg: 17, average: 13, lower: false },
    { elite: 22, aboveAvg: 18, average: 14, lower: false },
  ...
  broadJump: [
    { elite: 70,  aboveAvg: 58,  average: 46,  lower: false },
    { elite: 76,  aboveAvg: 64,  average: 52,  lower: false },
    { elite: 80,  aboveAvg: 68,  average: 56,  lower: false },
    { elite: 84,  aboveAvg: 72,  average: 60,  lower: false },
    { elite: 88,  aboveAvg: 76,  average: 64,  lower: false },
    { elite: 90,  aboveAvg: 78,  average: 66,  lower: false },
    { elite: 92,  aboveAvg: 80,  average: 68,  lower: false },
    { elite: 94,  aboveAvg: 82,  average: 70,  lower: false },
  ],
  // Bench -1 rep (already very low, avoiding zero/negative values)
  benchPress: [
    { elite: 1,  aboveAvg: 1,  average: 0,  lower: false },
    { elite: 1,  aboveAvg: 1,  average: 0,  lower: false },
    { elite: 1,  aboveAvg: 1,  average: 0,  lower: false },
    { elite: 2,  aboveAvg: 1,  average: 0,  lower: false },
    { elite: 4,  aboveAvg: 2,  average: 1,  lower: false },
